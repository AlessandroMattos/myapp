...
class MiningTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mining_type" do
    assert_difference('MiningType.count') do
      post mining_types_url, params: { mining_type: { acrony: @mining_type.acrony, description: @mining_type.description } }
    end
  ...
  test "should update mining_type" do
    patch mining_type_url(@mining_type), params: { mining_type: { acrony: @mining_type.acrony, description: @mining_type.description } }
